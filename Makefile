...
run:
	$(UTILS_DIR)/qemu-system-aarch64 -machine raspi4b -nographic -kernel $(OUT_DIR)/echoos.img
debug:
	$(UTILS_DIR)/qemu-system-aarch64 -machine raspi4b -nographic -kernel $(OUT_DIR)/echoos.elf -S -s
